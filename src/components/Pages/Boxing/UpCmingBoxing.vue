                          ...
                          >
                            <div class="d-flex align-items-center gap-1">
                              <img
                                ...
                                alt="Icon"
                              />
                              <span class="fs-eight cpoint">{{ $t('ui.usa_nhl') }}</span>
                            </div>
                            <div
