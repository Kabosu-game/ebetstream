                    ...
                    <TabGroup>
                      ...
                      >
                        <Tab
                          as="template"
                          v-slot="{ selected }"
                          v-for="{ imgSrc, sportKey, id } in tabTwo"
                          :key="id"
                        >
                          <button
                                  ...
                                  <div class="table-responsive">
                                    <table class="table mb-0 pb-0">
                                      <thead>
                                        <tr class="text-center">
                                          <th scope="col">
                                            <span class="fs-eight">{{ $t('ui.win_2') }}</span>
                                          </th>
                                          <th scope="col">
                                            <span class="fs-eight"
                                              >{{ $t('betting.first_set_winner') }}</span
                                ...
                                <div class="top_matches__clubname">
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      />
                                      <span class="fs-eight cpoint"
                                        >{{ $t('ui.international_euroleague') }}</span
                                      >
                                    </div>
                                    <div
                                    ...
                                    <table class="table mb-0 pb-0">
                                      <thead>
                                        <tr class="text-center">
                                          ...
                                          <th scope="col">
                                            <span class="fs-eight"
                                              >{{ $t('betting.handicap_incl_overtime') }}</span
                                            >
                                          </th>
                                        </tr>
                                      </thead>
                                ...
                                <div class="top_matches__clubname">
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      />
                                      <span class="fs-eight cpoint"
                                        >{{ $t('ui.international_euroleague_2') }}</span
                                      >
                                    </div>
                                    <div
                                      class="d-flex align-items-center gap-4 pe-xl-15 flex-nowrap flex-xl-wrap"
                                ...
                                <div class="top_matches__clubname">
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      />
                                      <span class="fs-eight cpoint"
                                        >{{ $t('ui.bangladesh_vs_newzealand') }}</span
                                      >
                                    </div>
                                    <div
                                    ...
                                    <table class="table mb-0 pb-0">
                                      <thead>
                                        <tr class="text-center">
                                          ...
                                          <th scope="col">
                                            <span class="fs-eight"
                                              >{{ $t('betting.draw_no_bet') }}</span
                                            >
                                          </th>
                                          <th scope="col">
                                            <span class="fs-eight"
                                              >{{ $t('betting.first_innings') }}</span
                                            >
                                          </th>
                                        </tr>
                                      </thead>
                                ...
                                <div class="top_matches__clubname">
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      />
                                      <span class="fs-eight cpoint"
                                        >{{ $t('ui.india_vijay_hazare_trophy') }}</span
                                      >
                                    </div>
                                    <div
                                      class="d-flex align-items-center gap-2 pe-xl-19 flex-nowrap flex-xl-wrap"
                                    ...
                                    <table class="table mb-0 pb-0">
                                      <thead>
                                        <tr class="text-center">
                                          <th scope="col">
                                            <span class="fs-eight"
                                              >{{ $t('ui.winner_incl_super_over') }}</span>
                                          </th>
                                        </tr>
                                      </thead>
