  ...
  <div class="tw-page">
    ...
    <section class="tw-page-hero">
      <div class="hero-inner">
        <p class="tw-page-hero__sub"><i class="fas fa-crown me-2"></i>Certification</p>
        <h1 class="tw-page-hero__title">Become an <span class="accent">Organizer</span></h1>
        <p class="hero-desc">Join our team of certified organizers and create quality e-sport events.</p>
      </div>
    </section>
    ...
    <div class="tw-page-body">
      ...
      <section class="two-col-section">
        ...
        <div class="tw-card info-card">
          ...
          <ul class="check-list">
            <li>Have already organized at least 3 tournaments or test events (internal or external)</li>
            <li>Present an organization plan (format, rules, qualification system)</li>
            <li>Master the official rules of the games used</li>
            <li>Have a stable connection and a powerful computer or mobile device</li>
            <li>Commit to respecting Ebetstream standards: fairness, transparency, impartiality</li>
          </ul>
        </div>
        ...
        <div class="tw-card info-card">
          ...
          <div class="doc-group">
            <h5 class="doc-group-title">Organizer-Specific Documents</h5>
            <ul class="doc-list">
              <li>Proof of a previously organized event (poster, link, results)</li>
              <li>Document showing the structure of the next tournament (PDF, Word, or image)</li>
              <li>Professional contact information (email, phone, social networks)</li>
            </ul>
          </div>
        </div>
      </section>
        ...
        <div class="tw-steps">
          ...
          <div class="tw-step">
            ...
            <div>
              ...
              <p class="tw-step__desc">Event management assessment to evaluate your organizational skills.</p>
            </div>
          </div>
          <div class="tw-step">
            ...
            <div>
              ...
              <p class="tw-step__desc">5-minute video call or video recording to discuss your experience.</p>
            </div>
          </div>
          <div class="tw-step">
            ...
            <div>
              ...
              <p class="tw-step__desc">Awarding of an official badge and access to advanced organizer tools.</p>
            </div>
          </div>
          <div class="tw-step">
      ...
      <section class="form-section">
        <div class="tw-card form-card">
          ...
          <CertificationForm type="organizer" />
        </div>
      </section>
