  ...
  <div class="tw-auth-page">
    <div class="tw-auth-card">
      ...
      <div class="tw-auth-logo">
        <router-link to="/">{{ $t('ui.ebetstream_2') }}</router-link>
      </div>
      ...
      <form @submit.prevent="registerUser" class="tw-auth-form">
        ...
        <div class="tw-field">
          ...
          <div class="tw-password-wrap">
            ...
            />
            <button type="button" class="tw-eye-btn" @click="showPassword = !showPassword" ::aria-label="$t('ui.showpassword_hide_password_show_password')">
        ...
        <div class="tw-field">
          ...
          <div class="tw-password-wrap">
            <input
              ...
              autocomplete="new-password"
            />
            <button type="button" class="tw-eye-btn" @click="showConfirm = !showConfirm" ::aria-label="$t('ui.showconfirm_hide_password_show_password')">
